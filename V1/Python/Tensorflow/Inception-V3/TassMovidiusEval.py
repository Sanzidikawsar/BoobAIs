############################################################################################
# Title: JumpWay Hub TASS Evaluator
# Description: Evaluator an Inception V3 neural network trained by TassMovidiusTrainer.
...
#    Example Usage:
#
#        $ python3.5 TassMovidiusEval.py
#
############################################################################################
     
print("")
print("")
print("!! Welcome to TASS Movidius Evaluator, please wait while the program initiates !!")
print("")
...
def run():
    ...
    if not os.path.exists(TassMovidiusEval._confs["ClassifierSettings"]["log_eval"]):
    ...
    with tf.Graph().as_default() as graph:
        ...
        images, raw_images, labels = TassMovidiusEval.loadBatch(dataset, is_training = False)

        #Create some information about the training steps
        num_batches_per_epoch = dataset.num_samples / TassMovidiusEval._confs["ClassifierSettings"]["test_batch_size"]
        ...
        #Get your supervisor
        sv = tf.train.Supervisor(logdir = TassMovidiusEval._confs["ClassifierSettings"]["log_eval"], summary_op = None, init_fn = restore_fn)
